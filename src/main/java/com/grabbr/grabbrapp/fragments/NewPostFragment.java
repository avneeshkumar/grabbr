...
import com.grabbr.grabbrapp.services.SendPost;
	   ...
	   public View onCreateView(LayoutInflater inflater,ViewGroup container, Bundle savedInstanceState){
		...
		back_button.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View arg0) {
				...
				fragmentTransaction.remove(NewPostFragment.this);
				...
				Bitmap bitmap3;
					...
					if(imageuri2==null&&imageuri3==null){
						...
						if(sharedpreferences.getString(c.isfb,"").equals("0")){
							new SendPost((Fragment)NewPostFragment.this,(NewsfeedActivity)getActivity(), heading, descrition, rupees, category, privacy, fb).execute(c.sendpost_url,"0",sharedpreferences.getString(c.username,""),sharedpreferences.getString(c.password,""));
						}
						else{
							new SendPost((Fragment)NewPostFragment.this,(NewsfeedActivity)getActivity(), heading, descrition, rupees, category, privacy, fb).execute(c.sendpost_url,"1",sharedpreferences.getString(c.fb_id,""),sharedpreferences.getString(c.fb_token,""),sharedpreferences.getString(c.username,""));
						}
					}
						...
						if(sharedpreferences.getString(c.isfb,"").equals("0")){
							new SendPost((Fragment)NewPostFragment.this,(NewsfeedActivity)getActivity(), heading, descrition, rupees, category, privacy, fb1,fb2).execute(c.sendpost_url,"0",sharedpreferences.getString(c.username,""),sharedpreferences.getString(c.password,""));
						}
						else{
							new SendPost((Fragment)NewPostFragment.this,(NewsfeedActivity)getActivity(), heading, descrition, rupees, category, privacy, fb1,fb2).execute(c.sendpost_url,"1",sharedpreferences.getString(c.fb_id,""),sharedpreferences.getString(c.fb_token,""),sharedpreferences.getString(c.username,""));
						}
					}
					else if(imageuri2!=null&&imageuri3==null){
						String realpath1 = util.getPath(getActivity(), imageuri1);
						...
						if(sharedpreferences.getString(c.isfb,"").equals("0")){
							new SendPost((Fragment)NewPostFragment.this,(NewsfeedActivity)getActivity(), heading, descrition, rupees, category, privacy, fb1,fb2,fb3).execute(c.sendpost_url,"0",sharedpreferences.getString(c.username,""),sharedpreferences.getString(c.password,""));
						}
						else{
							new SendPost((Fragment)NewPostFragment.this,(NewsfeedActivity)getActivity(), heading, descrition, rupees, category, privacy, fb1,fb2,fb3).execute(c.sendpost_url,"1",sharedpreferences.getString(c.fb_id,""),sharedpreferences.getString(c.fb_token,""),sharedpreferences.getString(c.username,""));
						}
