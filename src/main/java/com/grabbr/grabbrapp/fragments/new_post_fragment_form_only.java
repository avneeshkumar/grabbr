...
import com.grabbr.grabbrapp.services.SendPostForm;

@SuppressLint("NewApi")
public class new_post_fragment_form_only extends Fragment {
	...
	RelativeLayout back_relative_layout;
	...
	@Override
	   public View onCreateView(LayoutInflater inflater,ViewGroup container, Bundle savedInstanceState){
		...
		back_relative_layout = (RelativeLayout) v.findViewById(R.id.back_rel_layout);
		back_relative_layout.setVisibility(View.GONE);
		...
		back_button.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View arg0) {
				...
				fragmentTransaction.remove(new_post_fragment_form_only.this);
				...
				Bitmap bitmap3;
					...
					if(imageuri2==null&&imageuri3==null){
						...
						if(sharedpreferences.getString(c.isfb,"").equals("0")){
							new SendPostForm((Fragment)new_post_fragment_form_only.this,(MyProfileActivity)getActivity(), heading, descrition, rupees, category, privacy, fb).execute(c.sendpost_url,"0",sharedpreferences.getString(c.username,""),sharedpreferences.getString(c.password,""));
						}
						else{
							new SendPostForm((Fragment)new_post_fragment_form_only.this,(MyProfileActivity)getActivity(), heading, descrition, rupees, category, privacy, fb).execute(c.sendpost_url,"1",sharedpreferences.getString(c.fb_id,""),sharedpreferences.getString(c.fb_token,""),sharedpreferences.getString(c.username,""));
						}
					}
						...
						if(sharedpreferences.getString(c.isfb,"").equals("0")){
							new SendPostForm((Fragment)new_post_fragment_form_only.this,(MyProfileActivity)getActivity(), heading, descrition, rupees, category, privacy, fb1,fb2).execute(c.sendpost_url,"0",sharedpreferences.getString(c.username,""),sharedpreferences.getString(c.password,""));
						}
						else{
							new SendPostForm((Fragment)new_post_fragment_form_only.this,(MyProfileActivity)getActivity(), heading, descrition, rupees, category, privacy, fb1,fb2).execute(c.sendpost_url,"1",sharedpreferences.getString(c.fb_id,""),sharedpreferences.getString(c.fb_token,""),sharedpreferences.getString(c.username,""));
						}
					}
					else if(imageuri2!=null&&imageuri3==null){
						String realpath1 = util.getPath(getActivity(), imageuri1);
						...
						if(sharedpreferences.getString(c.isfb,"").equals("0")){
							new SendPostForm((Fragment)new_post_fragment_form_only.this,(MyProfileActivity)getActivity(), heading, descrition, rupees, category, privacy, fb1,fb2,fb3).execute(c.sendpost_url,"0",sharedpreferences.getString(c.username,""),sharedpreferences.getString(c.password,""));
						}
						else{
							new SendPostForm((Fragment)new_post_fragment_form_only.this,(MyProfileActivity)getActivity(), heading, descrition, rupees, category, privacy, fb1,fb2,fb3).execute(c.sendpost_url,"1",sharedpreferences.getString(c.fb_id,""),sharedpreferences.getString(c.fb_token,""),sharedpreferences.getString(c.username,""));
						}
