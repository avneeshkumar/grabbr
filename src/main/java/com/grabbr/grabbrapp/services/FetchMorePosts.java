...
public class FetchMorePosts extends AsyncTask<String, Void, HttpResponse >{
    ...
    private NewsfeedData last_row_item;
    
    public FetchMorePosts(Context context,ListView Lv,NewsfeedListAdapter adapter,NewsfeedData last_row_item){
        ...
        this.last_row_item = last_row_item;
    }
        ...
        if(sharedpreferences.getString(constant.isfb,"").equals("0")){
            try {
				...
				HttpEntity reqEntity = MultipartEntityBuilder.create().
                        ...
                        build();
                response = myutils.sendPost(params[0]+last_row_item.getPostId()+"/", reqEntity,httpclient);
