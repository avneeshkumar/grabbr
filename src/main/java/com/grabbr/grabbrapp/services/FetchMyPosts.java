...
public class FetchMyPosts extends AsyncTask<String, Void, HttpResponse >{
    ...
    public FetchMyPosts(Context context,ListView Lv,List<NewsfeedData> rowItems,MyProfileNewsfeedAdapter adapter){
