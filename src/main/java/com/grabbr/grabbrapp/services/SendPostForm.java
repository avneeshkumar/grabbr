...
public class SendPostForm extends AsyncTask<String, Void, HttpResponse >  {
	
	MyProfileActivity myprofileactivty;
	String heading;
	String descrition;
	String rupees ;
	String category;
	...
	public SendPostForm(Fragment myf,MyProfileActivity cf,String head,String des,String rup,String cat,String pri,FileBody f1,FileBody f2,FileBody f3) {
	...
	public SendPostForm(Fragment myf,MyProfileActivity cf,String head,String des,String rup,String cat,String pri,FileBody f1,FileBody f2) {
		// TODO Auto-generated constructor stub
		myprofileactivty = cf;
		f=myf;
		heading=head;
	...
	public SendPostForm(Fragment myf,MyProfileActivity cf,String head,String des,String rup,String cat,String pri,FileBody f1) {
		// TODO Auto-generated constructor stub
		f=myf;
		myprofileactivty = cf;
		heading=head;
		...
		if(statusCode==201){
			...
			try {
				...
				try {
					...
					Toast.makeText(myprofileactivty.getApplicationContext(), "Sucessfully posted.", Toast.LENGTH_SHORT).show();
					myprofileactivty.getSupportFragmentManager().beginTransaction().remove(f).commit();
			...
			//progress.setProgress(100);
			Toast.makeText(myprofileactivty.getApplicationContext(), "Invalid username password combination", Toast.LENGTH_SHORT).show();
		}
		else if(statusCode==200){
			//progress.setProgress(100);
			Log.d("register_facebook","Error code 200");
			Toast.makeText(myprofileactivty.getApplicationContext(), "Email already exits", Toast.LENGTH_SHORT).show();
		}
		else{
			//progress.setProgress(100);
			...
			Toast.makeText(myprofileactivty.getApplicationContext(), "Service unavailable", Toast.LENGTH_SHORT).show();
		}
