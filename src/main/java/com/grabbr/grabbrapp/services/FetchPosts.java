...
public class FetchPosts extends AsyncTask<String, Void, HttpResponse >{
    ...
    public FetchPosts(Context context,ListView Lv,List<NewsfeedData> rowItems,NewsfeedListAdapter adapter){
