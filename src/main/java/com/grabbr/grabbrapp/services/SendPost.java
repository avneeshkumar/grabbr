...
public class SendPost extends AsyncTask<String, Void, HttpResponse >  {
	...
	public SendPost(Fragment myf,NewsfeedActivity cf,String head,String des,String rup,String cat,String pri,FileBody f1,FileBody f2,FileBody f3) {
	...
	public SendPost(Fragment myf,NewsfeedActivity cf,String head,String des,String rup,String cat,String pri,FileBody f1,FileBody f2) {
		// TODO Auto-generated constructor stub
		newsfeedactivity = cf;
		f=myf;
		heading=head;
	...
	public SendPost(Fragment myf,NewsfeedActivity cf,String head,String des,String rup,String cat,String pri,FileBody f1) {
		// TODO Auto-generated constructor stub
		f=myf;
		newsfeedactivity = cf;
		heading=head;
		...
		if(statusCode==201){
			...
			try {
				...
				try {
					...
					Toast.makeText(newsfeedactivity.getApplicationContext(), "Sucessfully posted.", Toast.LENGTH_SHORT).show();
					newsfeedactivity.getSupportFragmentManager().beginTransaction().remove(f).commit();
			...
			//progress.setProgress(100);
			Toast.makeText(newsfeedactivity.getApplicationContext(), "Invalid username password combination", Toast.LENGTH_SHORT).show();
		}
		else if(statusCode==200){
			//progress.setProgress(100);
			Log.d("register_facebook","Error code 200");
			Toast.makeText(newsfeedactivity.getApplicationContext(), "Email already exits", Toast.LENGTH_SHORT).show();
		}
		else{
			//progress.setProgress(100);
			...
			Toast.makeText(newsfeedactivity.getApplicationContext(), "Service unavailable", Toast.LENGTH_SHORT).show();
		}
