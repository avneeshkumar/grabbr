...
public class FetchFollow extends AsyncTask<String, Void, HttpResponse > {
    ...
    private ListView lv;
    public ArrayList<FollowersData> followList;
    String follow_following;
    private ProgressDialog progress;

    public FetchFollow(Context context,ListView lv,ArrayList<FollowersData> followList,String f) {
    ...
    protected void onPostExecute(HttpResponse httpResponse) {
        ...
        if (httpResponse != null) {
            ...
            if (statusCode == 200) {
                ...
                try {
                    ...
                    try {
                        for (int i = 0; i < reader.length(); i++) {
                            ...
                            ri.setFollowed(fields.getString("follower"));
                            ri.setUserID(obj.getString("pk"));
                            followList.add(ri);
                            if(isCancelled())
                            	break;
                        }
                ...
                if(!isCancelled()){
                	lv.setAdapter(new FollowerListAdapter(context, followList,follow_following));
                }
            } else {
